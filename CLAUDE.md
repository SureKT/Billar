...
- **Ancho por página, no global.** No hay tope de ancho heredado — cada página fija su `maxWidth` centrado en desktop (regla anti-estiramiento). Topes actuales: Partida 1000, Inicio 860 (columna única, sin aside), Jugadores/Logros 1100, Reglas 960 (índice 200 + texto 720), NuevaPartida 960, Torneos 1100, TorneoDetalle 760. Al crear página nueva: ponerle su tope, no dejarla a ancho completo. Evitar asides que queden semivacíos — si el panel lateral no se llena en todos los estados, mejor columna única.
